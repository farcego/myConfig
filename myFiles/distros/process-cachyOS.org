...
sudo apt-get remove kodi kodi-x11                   -y
sudo apt-get install kodi                           -y
sudo apt-get install rjags                          -y
sudo apt-get install ubuntu-pro-client              -y
...
# quarto
#
wget https://github.com/quarto-dev/quarto-cli/releases/download/v1.4.550/quarto-1.4.550-linux-amd64.deb^C
sudo dpkg -i quarto-1.4.550-linux-amd64.deb
# if any error in dependencies
...
sudo dpkg -i ~/HOME-INST-/software/linux/libassuan0_2.5.3-7.1_amd64.deb
sudo dpkg -i ~/HOME-INST/software/linux/libpkcs11-dnie_1.6.8_amd64.deb


# para mpv player $ nota, me puede servir para el proyecto de la camara de aves y python

sudo curl --output-dir /etc/apt/trusted.gpg.d -O https://apt.fruit.je/fruit.gpg

echo 'deb http://apt.fruit.je/debian noble mpv' | sudo tee /etc/apt/sources.list.d/fruit.list

sudo apt update
sudo apt install mpv
# this one tidy is for using R CMD check
